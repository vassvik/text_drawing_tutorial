...
int main()
{
    ...
    // try to read and compile the shaders from file
    ...
    // create and bind VBO, and specify the attribute data to match the vertex shader
...
// Functions from previous checkpoints
void init()
{
    if (!glfwInit()) {
    ...
    // We need additional window hints to specify the OpenGL profile 
